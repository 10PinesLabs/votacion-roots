...
public class To2TemaDeReunionConverter implements SpecializedTypeConverter<TemaDeReunionTo, TemaDeReunion> {
    ...
    private final Map<Type, Type> domainClass = new HashMap<Type, Type>() {{
        ...
        put(TemaParaRepasarActionItemsSinTemasParaRepasarTo.class, TemaParaRepasarActionItems.class);
    }};
}
